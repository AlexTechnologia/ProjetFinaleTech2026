...
window.ITEM_DB = {
  // --- Materiaux ---
  wood:            { name: "Bois", icon: "\ud83e\udeb5", type: "material", desc: "Bois de chene." },
  birch_wood:      { name: "Bois de bouleau", icon: "\ud83c\udf33", type: "material", desc: "Bois clair de bouleau." },
  bark:            { name: "Ecorce", icon: "\ud83c\udf3f", type: "material", desc: "Ecorce d'arbre." },
  rock:            { name: "Pierre", icon: "\ud83e\udea8", type: "material", desc: "Pierre brute." },
  flint:           { name: "Silex", icon: "\ud83d\udd2a", type: "material", desc: "Silex tranchant." },
  iron_ore:        { name: "Minerai de fer", icon: "\u26ab", type: "material", desc: "Minerai de fer brut." },
  iron_bar:        { name: "Lingot de fer", icon: "\ud83d\udd29", type: "material", desc: "Lingot de fer fondu." },
  gold_bar:        { name: "Lingot d'or", icon: "\ud83e\udd47", type: "material", desc: "Lingot d'or precieux." },
  stone_brick:     { name: "Brique de pierre", icon: "\ud83e\uddf1", type: "material", desc: "Brique taillee." },
  wheat:           { name: "Ble", icon: "\ud83c\udf3e", type: "material", desc: "Ble sauvage." },
  // --- Consommables ---
  raw_meat:        { name: "Viande crue", icon: "\ud83e\udd69", type: "consumable", health: 5, hunger: 15, desc: "Mieux vaut la cuire." },
  cooked_meat:     { name: "Viande cuite", icon: "\ud83c\udf56", type: "consumable", health: 20, hunger: 50, desc: "Viande cuite savoureuse." },
  pink_shroom:     { name: "Champignon rose", icon: "\ud83c\udf44", type: "consumable", stamina: 30, desc: "+30 endurance." },
  red_shroom:      { name: "Champignon rouge", icon: "\ud83c\udf44", type: "consumable", health: 30, desc: "+30 vie." },
  yellow_shroom:   { name: "Champignon jaune", icon: "\ud83c\udf44", type: "consumable", hunger: 30, desc: "+30 faim." },
  bread:           { name: "Pain", icon: "\ud83c\udf5e", type: "consumable", hunger: 40, health: 10, desc: "+40 faim, +10 vie." },
  soup:            { name: "Soupe", icon: "\ud83c\udf72", type: "consumable", hunger: 60, health: 30, stamina: 20, desc: "Restaure tout." },
  // --- Outils & armes ---
  wooden_axe:      { name: "Hache en bois", icon: "\ud83e\ude93", type: "tool", damage: 5, desc: "Pour couper le bois." },
  wooden_pickaxe:  { name: "Pioche en bois", icon: "\u26cf\ufe0f", type: "tool", damage: 5, desc: "Pour miner la pierre." },
  wooden_sword:    { name: "Epee en bois", icon: "\ud83d\udde1\ufe0f", type: "tool", damage: 8, desc: "Arme de base." },
  wooden_shield:   { name: "Bouclier en bois", icon: "\ud83d\udee1\ufe0f", type: "tool", armor: 5, desc: "Reduit les degats." },
  stone_axe:       { name: "Hache en pierre", icon: "\ud83e\ude93", type: "tool", damage: 15, desc: "Recolte le bois plus vite." },
  stone_pickaxe:   { name: "Pioche en pierre", icon: "\u26cf\ufe0f", type: "tool", damage: 15, desc: "Mine plus vite." },
  stone_sword:     { name: "Epee en pierre", icon: "\ud83d\udde1\ufe0f", type: "tool", damage: 18, desc: "Plus tranchante." },
  iron_axe:        { name: "Hache en fer", icon: "\ud83e\ude93", type: "tool", damage: 30, desc: "Hache solide." },
  iron_pickaxe:    { name: "Pioche en fer", icon: "\u26cf\ufe0f", type: "tool", damage: 30, desc: "Mine le fer." },
  iron_sword:      { name: "Epee en fer", icon: "\u2694\ufe0f", type: "tool", damage: 35, desc: "Arme fiable." },
  steel_sword:     { name: "Epee en acier", icon: "\u2694\ufe0f", type: "tool", damage: 55, desc: "Tres puissante." },
  gold_sword:      { name: "Epee en or", icon: "\u2694\ufe0f", type: "tool", damage: 45, desc: "Brillante et rapide." },
  bow:             { name: "Arc", icon: "\ud83c\udff9", type: "tool", damage: 25, range: 15, desc: "Attaque a distance." },
  flint_arrows:    { name: "Fleches en silex", icon: "\ud83c\udff9", type: "ammo", desc: "Munitions pour l'arc." },
  iron_armor:      { name: "Armure en fer", icon: "\ud83d\udee1\ufe0f", type: "armor", armor: 15, desc: "Protection lourde." },
  // --- Structures ---
  campfire:        { name: "Feu de camp", icon: "\ud83d\udd25", type: "structure", desc: "Eclaire la nuit." },
  workbench:       { name: "Etabli", icon: "\ud83e\ude9a", type: "structure", desc: "Debloque des recettes." },
  furnace:         { name: "Fournaise", icon: "\ud83c\udfed", type: "structure", desc: "Fond les minerais." },
  anvil:           { name: "Enclume", icon: "\u2692\ufe0f", type: "structure", desc: "Forge le metal." },
  cauldron:        { name: "Chaudron", icon: "\ud83e\uded5", type: "structure", desc: "Cuisine les aliments." },
  fletching_table: { name: "Table de fleches", icon: "\ud83c\udff9", type: "structure", desc: "Cree arcs et fleches." },
};
...
class PlayerAdapter {
  ...
  _stats(dt) {
    ...
    // Starvation: drain health once per second AND actually trigger death.
    if (this.hunger <= 0) {
      this._starveAccum = (this._starveAccum || 0) + dt;
      if (this._starveAccum >= 1) { this._starveAccum -= 1; this.takeDamage(4, 'Famine'); }
    } else {
      this._starveAccum = 0;
    }
  }
